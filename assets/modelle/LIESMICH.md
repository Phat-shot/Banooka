...
Diese vierzehn Namen sind der Standard; sie werden ohne Rücksicht auf
...
| `HangDuck` | 1,0 s | ja | hängt mit angezogenen Beinen (○ gehalten) |
| `HangSpin` | 0,4 s | ja | Drehschlag im Hängen, Beine schleudern herum |
